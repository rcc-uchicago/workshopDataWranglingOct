...
# USER MODIFIABLE PARAMETERS:
 ...
 PYTHON_MODULE="python/anaconda-2020.02"  # Python module to use -- midway changes that
 CONDA_ENV="/scratch/midway2/humaasif/conda-env"    # conda environment name to source. If left unset it will use the base conda
R_MODULE="R/3.6.1"
